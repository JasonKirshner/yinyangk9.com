...
const Footer = () => {
  return (
    <footer className={styles.footer}>
      <InViewLoad>
        <img src={heroImage} alt='Footer Background' className={styles.bgImage} />
      </InViewLoad>
