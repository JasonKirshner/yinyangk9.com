        ...
        <div className={styles.footerRight}>
          ...
          {/* <div className={styles.socials}>
            <Link href="http://facebook.com" className={styles.socialLink}>
              <Image src={fbImage} alt="Facebook Icon" className={styles.socialIcon} />
            </Link>
            <Link href="https://www.instagram.com/yinyangk9/" className={styles.socialLink}>
              <Image src={igImage} alt="Facebook Icon" className={styles.socialIcon} />
            </Link>
          </div> */}
        </div>
      </div>
